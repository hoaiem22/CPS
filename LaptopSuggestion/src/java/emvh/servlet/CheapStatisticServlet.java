 ...
 */
@WebServlet(name = "CheapStatisticServlet", urlPatterns = {"/CheapStatisticServlet"})
public class CheapStatisticServlet extends HttpServlet {
...
//            System.out.println("LOG: " + marshallToString(laptops));
            ...
            Logger.getLogger(CheapStatisticServlet.class.getName()).log(Level.SEVERE, null, ex);
        } finally {
